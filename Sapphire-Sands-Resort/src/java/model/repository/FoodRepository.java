...
public class FoodRepository {
    ...
    public static List<Food> getListFood() {
        ...
        try (Connection conn = DBConnect.getConnection()) {
            ...
            System.out.println("========Loi getlist Food trong Food repo==============");
        }
        return list;
    }
...
//        Reset lại chuỗi cookie đầu vào cho đúng form: ID:Amount
        ...
        for (String element : id_amount) {
            ...
            try (Connection conn = DBConnect.getConnection()) {
                ...
                System.out.println("==========Loi getListFoodCart trong FoodRepo===========");
            }
        }
        return list;
    }
    ...
    public static void insertintoOrderDetail(String txt, String orderID) {
        ...
        for (String element : id_amount) {
            ...
            try (Connection conn = DBConnect.getConnection()) {
                ...
                System.out.println(e);
                System.out.println("===========Loi insert to OrderDetail trong FoodRepo=========");
            }
        }
    }
