...
<c:if test="${sessionScope.employee.role!=1}">
    <% response.sendRedirect("employee_login");%>
</c:if>

<jsp:useBean class="model.repository.EmployeeRepository" scope="page" id="show"></jsp:useBean>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <table class="table text-start align-middle table-bordered table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr id="row${i.orderID}">
                                        ...
                                        <td>${i.people}</td>
                                        <td>
                                            <a class="btn btn-sm btn-primary" href="customer_payment?orderID=${i.orderID}">Thanh toán</a>  
                                        </td>
                                    </tr>   
                                    </c:forEach>
                                </tbody>
