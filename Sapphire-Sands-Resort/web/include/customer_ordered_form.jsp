                    ...
                    <tbody>
                        <c:forEach items="${listRoom0}" var="r">
                            <tr>
                                ...
                                <td><fmt:formatNumber value="${r.roomPrice*r.dayStay}" pattern="#,##0.###"/></td>
                                <td>
                                    <a href="cancel_room?orderID=${r.orderID}"
                                            class="btn btn-primary">
                                        HUỶ PHÒNG
                                    </a>
                                </td>
...
<!--            <div class="col-md-12">
            ...
            <div class=" mx-2">
                <div class="bg-light rounded p-4">
                    ...
                    <div class="table-responsive">
                       <%-- <p>Số Lượng dịch vụ: <fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${listRoom0.size()+ listService.size() + listFood.size()}"/></p> --%>
